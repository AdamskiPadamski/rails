...
class AnimesControllerTest < ActionController::TestCase
  ...
  test "should create anime" do
    assert_difference('Anime.count') do
      post :create, anime: { number_of_episodes: @anime.number_of_episodes, title: @anime.title, year: @anime.year }
    end
  ...
  test "should update anime" do
    patch :update, id: @anime, anime: { number_of_episodes: @anime.number_of_episodes, title: @anime.title, year: @anime.year }
    assert_redirected_to anime_path(assigns(:anime))
  end
